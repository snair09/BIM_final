...
bedtools slop -i ${INPUT_DIR}/clipper_5p.bed -g ${GENOME_FAI} -b 202 > ${INPUT_DIR}/ext.bed
...
bedtools shuffle -i ${INPUT_DIR}/clipper_5p.bed -g ${GENOME_FAI} -excl ${INPUT_DIR}/ext.bed > ${INPUT_DIR}/negatives.bed
...
echo "Preprocessing complete for RBP: ${RBP}"
